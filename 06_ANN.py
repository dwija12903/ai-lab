...
class NeuralNetwork:
    ...
    # sigmoid function is used to introducing non linearity
    ...
    def backward(self, X, y, output):
        ...
        # These gradients tell us how much the loss would change if we made small adjustments to each weight and bias in the network.
        # gradient of the output layer using the derivative of the sigmoid function and the error.
